                                                ...
                                                <div class="col-md-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label></label>
                                                            <div class="input-group">
                                                                <a href="#" class="btn btn-sm btn-primary float-end" id="print_statement_report"><i class="fas fa-print "></i> @lang('Print')</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="row margin_row mt-1">
                        <div class="card">
                            <div class="section-header">
                                <div class="col-md-10">
                                    <h6>@lang('Sale Statement List')</h6>
                                </div>
                            </div>
                                    ...
                                    {{-- <table class="display data_tbl data__table table-hover"> --}}
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>@lang('Shipment Charge')</th>
                                                <th>@lang('Total Payable Amt').</th>
                                                <th>@lang('Paid Amt').</th>
