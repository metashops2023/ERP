...
<div class="row">
    <div class="col-md-12 text-center">
        ...
        @endif
        <h6 style="margin-top: 10px;"><b>@lang('Stock Adjustment Report') </b></h6>
    </div>
</div>
<br>
<div class="row">
        ...
        <table class="table modal-table table-sm table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-end">@lang('Total Amount')({{json_decode($generalSettings->business, true)['currency']}})</th>
                    <th class="text-end">@lang('Total Recovered Amount')({{json_decode($generalSettings->business, true)['currency']}})</th>
                </tr>
            </thead>
...
<div class="row">
    ...
    <div class="col-6">
        <table class="table modal-table table-sm table-bordered">
            <tbody>
                <tr>
                    <th class="text-end">@lang('Total Normal') : {{ json_decode($generalSettings->business, true)['currency'] }}</th>
                    <td class="text-end">
                ...
                <tr>
                    <th class="text-end">@lang('Total Abormal') : {{ json_decode($generalSettings->business, true)['currency'] }}</th>
                    <td class="text-end">
                ...
                <tr>
                    <th class="text-end">@lang('Total Adjustment') : {{ json_decode($generalSettings->business, true)['currency'] }}</th>
                    <td class="text-end">
