                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mt-3">
                                                            <a href="{{ route('reports.payroll.print') }}" class="btn btn-sm btn-primary float-end " id="print_report"><i class="fas fa-print "></i> @lang('Print')</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <table class="display data_tbl data__table">
                                        ...
                                        <tfoot>
                                            <tr class="bg-secondary">
                                                <th colspan="4" class="text-end text-white">@lang('Total') :</th>
