...
<div class="row">
    <div class="col-md-12 text-center">
        ...
        <h6 style="margin-top: 10px;"><b>@lang('Supplier Report')</b></h6> 
    </div>
</div>
<br/>
<div class="row">
        ...
        <table class="table modal-table table-sm table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-end">@lang('Total Purchase')</th>
    ...
    <div class="col-6">
        <table class="table modal-table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <th class="text-end">@lang('Total Purchase') : {{ json_decode($generalSettings->business, true)['currency'] }}</th>
                ...
                <tr>
                    <th class="text-end">@lang('Total Purchase Due') : {{ json_decode($generalSettings->business, true)['currency'] }}</th>
                    <td class="text-end">{{ App\Utils\Converter::format_in_bdt($allTotalDue) }}</td>
                </tr>

                <tr>
                    <th class="text-end">@lang('Total Returnable/Refundable Due') : {{ json_decode($generalSettings->business, true)['currency'] }}</th>
