                    ...
                    <div class="main__content">
                        <div class="sec-name">
                            <div class="name-head">
                                ...
                                <h5>@lang('Stock In-Out Report')</h5>
                            </div>
                        </div>
                                    ...
                                    <table class="display data_tbl data__table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>@lang('Sold Qty')</th>
                                                <th>@lang('Sold Price')({{ json_decode($generalSettings->business, true)['currency'] }})</th>
                                                <th>@lang('Customer')</th>
                                                <th>@lang('Stock In By')</th>
                                                <th>@lang('Stock In Date')</th>
                                                <th>@lang('Lot No')</th>
                                                {{-- <th>@lang('Stock In Qty')</th> --}}
                                        ...
                                        <tfoot>
                                            <tr class="bg-secondary">
                                                <th colspan="4" class="text-white text-end">@lang('Total Sold Qty'): </th>
