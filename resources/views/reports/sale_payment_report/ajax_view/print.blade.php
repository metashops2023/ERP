...
<div class="row">
    <div class="col-md-12 text-center">
        ...
        @endif
        <h6 style="margin-top: 10px;"><b>@lang('Sale/Receive Payment Report') </b></h6>
    </div>
</div>
<br>
<div class="row">
...
<div class="row">
    ...
    <div class="col-6">
        <table class="table modal-table table-sm table-bordered">
            <thead>
                <tr>
                    <th class="text-end">@lang('Total Received Amount') : {{json_decode($generalSettings->business, true)['currency'] }}</th>
