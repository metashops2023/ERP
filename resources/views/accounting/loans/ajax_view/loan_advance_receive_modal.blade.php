...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">@lang('Loan Advance Receive')</h6>
        ...
        <div class="modal-body" id="payment_modal_body">
            <div class="info_area mb-2">
                <div class="row">
                    <div class="col-md-6">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong>@lang('Company') : </strong><span class="card_text">{{ $company->name }}</span>
                                </li>
                    ...
                    <div class="col-md-6">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong>@lang('Total Loan')&Advance : </strong>
                                ...
                                <li><strong>@lang('Total Received') : </strong>
                                    {{ json_decode($generalSettings->business, true)['currency'] }}
            ...
            <form id="loan_payment_form" action="{{ route('accounting.loan.advance.receive.store', $company->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row mt-3">
                    <div class="col-md-12">
                        <button type="button" class="btn loading_button_p loading_button d-none"><i class="fas fa-spinner text-primary"></i><b> @lang('Loading')...</b></button>
                        <button name="action" value="save" type="submit" class="c-btn button-success float-end submit_button" id="add_payment">@lang('Save')</button>
