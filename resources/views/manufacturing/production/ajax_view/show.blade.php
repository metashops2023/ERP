        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    @lang('Production Details (Reference ID)') : <strong>{{ $production->reference_no }}</strong>)
                </h5>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table modal-table table-sm table-striped">
                                <thead>
                                    <tr class="bg-primary">
                                        <th class="text-white text-start">@lang('Ingredient Name')</th>
                                        <th class="text-white text-start">@lang('Input Qty')</th>
                                        <th class="text-white text-start">@lang('Unit Cost Inc').Tax({{ json_decode($generalSettings->business, true)['currency'] }})</th>
            ...
            <div class="modal-footer">
               <div class="row">
                   <div class="col-md-12">
                       <a href="{{ route('manufacturing.productions.edit', $production->id) }}" class="c-btn btn_secondary py-1 text-white">@lang('Edit')</a>
