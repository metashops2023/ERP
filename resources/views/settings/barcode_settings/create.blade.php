                            ...
                            <div class="col-md-8">
                                <div class="form_element m-0 mt-4">
                                    <div class="py-2 px-2 form-header">
                                        <div class="row">
                                            <div class="col-8"><h5>@lang('Add barcode sticker setting')</h5></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="name" class="form-control" id="name"
                                                            placeholder="@lang('Sticker Sheet setting Name')" autofocus>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <textarea class="form-control" name="description" id="" cols="10" rows="3" placeholder="@lang('Sticker Sheet setting Description')"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="top_margin" id="top_margin" placeholder="@lang('Additional Top Margin')" value="0">
                                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="left_margin" id="left_margin" placeholder="@lang('Additional Left Margin')" value="0">
                                                        </div>
                                                        <span class="error error_top_margin"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="sticker_width" id="sticker_width" placeholder="@lang('Sticker Width')">
                                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="sticker_height" id="sticker_height" placeholder="@lang('Sticker Height')">
                                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="paper_width" id="paper_width" placeholder="@lang('Paper Width')">
                                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="paper_height" id="paper_height" placeholder="@lang('Paper Height')">
                                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="row_distance" id="row_distance" placeholder="@lang('Row Distance')" value="0">
                                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="column_distance" id="column_distance" placeholder="@lang('Colunmns Distance')" value="0">
                                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="stickers_in_a_row" id="stickers_in_a_row" placeholder="@lang('Stickers In a Row')">
                                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="any" class="form-control" name="stickers_in_one_sheet" id="stickers_in_one_sheet" placeholder="@lang('No. of Stickers per sheet')">
                                                        </div>
