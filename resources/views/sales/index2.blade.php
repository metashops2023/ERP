                                    ...
                                    {{-- <table class="display data_tbl modal-table table-sm table-striped"> --}}
                                        ...
                                        <thead>
                                            {{-- <tr>
                                                ...
                                                <th>@lang('Sell Due')({{ json_decode($generalSettings->business, true)['currency'] }})</th>
                                                <th>@lang('Total Amount')({{ json_decode($generalSettings->business, true)['currency'] }})</th>
...
@push('scripts')
    ...
    <script>
        ...
        // Make print
        $(document).on('click', '.print_b2c_btn',function (e) {
           e.preventDefault();

            var body = $('.sale_print_b2c_template').html();
            // var header = $('.heading_area').html();
