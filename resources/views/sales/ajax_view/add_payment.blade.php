...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="payment_heading">@lang('Receive Payment')</h6>
                    ...
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong>@lang('Customer') : </strong><span>{{ $sale->customer ? $sale->customer->name : 'Walk-In-Customer' }}</span> </li>
                                <li><strong>@lang('Business') : </strong><span>{{ $sale->customer ? $sale->customer->business_name : '' }}</span> </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong> @lang('Invoice ID') : </strong><span>{{ $sale->invoice_id }}</span> </li>
                                <li>
                                    <strong>@lang('Branch/Business') : </strong>
                                    <span>
                                        @if ($sale->branch)
