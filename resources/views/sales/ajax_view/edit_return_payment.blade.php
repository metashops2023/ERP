...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="payment_heading">@lang('Edit Return Payment')</h6>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong>@lang('Customer') : </strong><span>{{ $payment->customer ? $payment->customer->name : 'Walk-In-Customer' }}</span> </li>
                                <li><strong>@lang('Business') : </strong><span>{{ $payment->customer ? $payment->customer->business_name : '' }}</span> </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong> @lang('Invoice ID') : </strong><span>{{ $payment->sale_return->invoice_id }}</span> </li>
                    ...
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li class="sale_due">
                                    <strong>@lang('Total Return Amount'): {{ json_decode($generalSettings->business, true)['currency'] }} </strong>
                                    <span>{{ $payment->sale_return->total_return_amount }}</span> 
                                </li>

                                <li class="sale_due">
                                    <strong>@lang('Total Paid/Refunded Amount'): {{ json_decode($generalSettings->business, true)['currency'] }} </strong>
