        ...
        <div class="details_area">
                        ...
                        <div class="col-md-4 col-sm-4 col-lg-4">
                            <div class="heading text-right">
                                ...
                                @if ($sale->branch->add_sale_invoice_layout->branch_email)
                                    <h6>@lang('Eamil') : {{ $sale->branch->email }}</h6>
                                @endif
            ...
            <div class="purchase_and_deal_info pt-3">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            <li><strong> @lang('Draft No') : {{ $sale->invoice_id }}</strong></li>
                            <li><strong> @lang('Date') : {{ $sale->date }}</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            ...
                            <li><strong> @lang('Date') : {{ $sale->date }}</strong></li>
                            <li><strong> @lang('Entered By') : {{$sale->admin ? $sale->admin->prefix . ' ' . $sale->admin->name . ' ' . $sale->admin->last_name : 'N<A' }}</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
