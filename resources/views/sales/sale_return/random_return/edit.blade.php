                                    ...
                                    <div class="row">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    <div style="position: relative;">
                                                        <input type="text" name="sale_invoice_id" id="sale_invoice_id" class="form-control scanable" placeholder="@lang('Search And Select Sale Invoice ID')" autocomplete="off" value="{{ $return->sale ? $return->sale->invoice_id : '' }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="invoice_id" id="invoice_id" class="form-control" placeholder="@lang('Sale Return Invoice ID')" autocomplete="off" value="{{ $return->invoice_id }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="searching_area" style="position: relative;">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input {{ $return->sale_id ? 'disabled' : '' }} type="text" name="search_product" class="form-control scanable" id="search_product" placeholder="@lang('Search Product by product code(SKU) / Scan bar code')" autocomplete="off" autofocus>
                                                    </div>
                                            ...
                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <select name="return_discount_type" class="form-control" id="return_discount_type">
                                                                        <option {{ $return->return_discount_type == 1 ? 'SELECTED' : '' }} value="1">@lang('Fixed')(0.00)</option>
                                                                        <option {{ $return->return_discount_type == 2 ? 'SELECTED' : '' }} value="2">@lang('Percentage')(%)</option>
                                                                    </select>
                                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group mt-1">
                                                        ...
                                                        <div class="col-8">
                                                            <input readonly type="number" step="any" name="total_return_amount" id="total_return_amount" class="form-control" value="{{ $return->total_return_amount }}" placeholder="@lang('Total Return Amount')" tabindex="-1">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group mt-1">
                                                        <label class="col-4"><b>@lang('Return Note') :</b></label>
                                                        <div class="col-8">
                                                            <input type="number" step="any" name="return_note" id="return_note" class="form-control" value="{{ $return->return_note }}" placeholder="@lang('Return Note')">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group mt-1">
                                                        <label class="col-4"><b>@lang('Provious Refunded Amount') :</b></label>
                                                        <div class="col-8">
                ...
                <div class="submitBtn">
                    <div class="row justify-content-center">
                        <div class="col-12 text-end">
                            ...
                            <button type="submit" id="save_changes" class="btn btn-sm btn-success submit_button">@lang('Save Changes')</button>
                        </div>
                    </div>
                </div>
            </form>
