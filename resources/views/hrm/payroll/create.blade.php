                            ...
                            <div class="col-md-8">
                                <div class="form_element m-0 mt-4">
                                    <div class="py-2 px-2 form-header">
                                        <div class="row">
                                            <div class="col-8"><h5>@lang('Generate Payroll Of') {{ $month.'<'.$year }}</h5></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" step="any" name="duration_time" id="duration_time" class="form-control"
                                                    placeholder="@lang('Total Work Duration')" autofocus value="{{ $totalHours }}">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" step="any" name="amount_per_unit" id="amount_per_unit"
                                                    class="form-control" placeholder="@lang('Amount per unit duration')" value="">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input readonly type="total" step="any" name="total_amount"
                                                    id="total_amount" class="form-control" placeholder="@lang('total')" value="0.00">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                                        ...
                                                                        <td>
                                                                            <select class="form-control"
                                                                                ...
                                                                                <option
                                                                                    ...
                                                                                    value="1">@lang('Fixed')</option>
                                                                                <option
                                                                                    {{ $allowance->amount_type == 2 ? 'SELECTED' : '' }}
                                                                                    value="2">@lang('Percentage')</option>
                                                                            </select>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="@lang('Allowance Name')">
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <input type="number" step="any"
                                                                        name="allowance_amounts[{{ $index }}]"
                                                                        class="form-control"
                                                                        id="allowance_amount" placeholder="@lang('Amount')" value="0.00">
                                                                </td>
                                                    ...
                                                    <table class="table modal-table table-sm">
                                                        ...
                                                        <tbody id="deduction_body">
                                                                ...
                                                                @foreach ($deductions as $deduction)
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <input type="text" name="deduction_names[{{ $index2 }}]" id="deduction_name" class="form-control" placeholder="@lang('Deduction Name')" value="{{ $deduction->description }}">
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <input type="number" step="any" name="deduction_amounts[{{ $index2 }}]" id="deduction_amount" class="form-control" placeholder="@lang('Amount')" value="{{ $deduction->amount }}">
                                                                        </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="hidden" class="deduction-{{ $index2 }}" id="deductions">
                                                                    <input type="text"  name="deduction_names[{{ $index2 }}]" id="deduction_name" class="form-control" placeholder="@lang('Deduction Name')">
                                                                </td>
                                ...
                                <div class="form_element m-0 mt-2">
                                    <div class="element-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6 class="float-end">
                                                    @lang('Gross Amount') : <b><span class="span_gross_amount"><b>0.00</b></span></b>
