        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">@lang('Add Designation')</h6>
                ...
                <div class="modal-body">
                    ...
                    <form id="add_designation_form" action="{{ route('hrm.designations.store') }}">
                        <div class="form-group">
                            ...
                            <input type="text" name="designation_name" class="form-control" data-name="Designation name" placeholder="@lang('Designation name')" />
                        </div>

                        <div class="form-group mt-1">
                            <label><b>@lang('Designation Details') :</b> </label>
                            <textarea name="description" class="form-control" id="description" placeholder="@lang('Designation details')"></textarea>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="edit_designation_form" action="{{ route('hrm.designations.update') }}">
                        ...
                        <div class="form-group">
                            <label><b>@lang('Name') :</b> <span class="text-danger">*</span></label>
                            <input type="text" name="designation_name" class="form-control" id="e_designation_name" placeholder="@lang('Designation name')"/>
                        </div>

                        <div class="form-group mt-1">
                            <label><b>@lang('Designation Details') :</b> </label>
                            <textarea name="description" class="form-control" id="e_description" placeholder="@lang('Designation details')"></textarea>
                        </div>
