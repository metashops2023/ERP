...
@section('content')
                        ...
                        <div class="row">
                            <div class="form_element">
                                <div class="section-header">
                                    <div class="col-md-6">
                                        <h6>@lang('Allowances/Deductions')</h6>
                                    </div>
        ...
        <div class="modal-dialog col-40-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">@lang('Add Allowance/Deduction')</h6>
                    ...
                    <form id="add_allowance_form" action="{{ route('hrm.allowance.store') }}">
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input required type="text" name="description" class="form-control" placeholder="@lang('Description or Title')"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="type" required="">
                                    <option value="Allowance">@lang('Allowance')</option>
                        ...
                        <div class="form-group row">
                            <div class="col-6">
                                <label><b>@lang('Amount Type') :</b>  <span class="text-danger">*</span></label>
                                <select class="form-control" name="amount_type" id="amount_type">
                                    <option value="1">@lang('Fixed') (0.0)</option>
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" step="any" name="amount" class="form-control" placeholder="@lang('Amount')"/>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">@lang('Edit Allowance/Deduction')</h6>
                    <a href="" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                            class="fas fa-times"></span></a>
                </div>
