                            ...
                            <div class="form_element m-0 mt-4">
                                ...
                                <div class="element-body">
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <label for="inputEmail3" class="col-4"><b>@lang('Download Sample') :</b> </label>
                                                <div class="col-8">
                                                    <a href="{{ asset('import_template/supplier_import_template.xlsx') }}" class="btn btn-sm btn-success" download>@lang('Download Template File, Click Here')</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-sm modal-table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-start"> @lang('Supplier ID') </td>
                                                ...
                                                <tr>
                                                    <td class="text-start">16</td>
                                                    <td class="text-start">@lang('Prefix')</td>
                                                    <td class="text-start">@lang('Optional (If you leave this field blank, it will be generated automatically)').</td>
                                                </tr>
