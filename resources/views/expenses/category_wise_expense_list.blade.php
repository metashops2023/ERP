                    ...
                    <div class="main__content">
                        <div class="sec-name">
                            <div class="name-head">
                                ...
                                <h5>@lang('Category Wise Expenses')</h5>
                            </div>
                        </div>
                    ...
                    <div class="row margin_row mt-1">
                        <div class="card">
                            <div class="section-header">
                                <div class="col-md-10">
                                    <h6>@lang('Category Wise Expense List')</h6>
                                </div>
                            </div>
                                    ...
                                    <table class="display data_tbl data__table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-start">@lang('Expense Category')</th>
                                                <th class="text-start">@lang('Reference ID')</th>
                                                <th class="text-start">@lang('B.Location')</th>
                                                <th class="text-start">@lang('Expense For')</th>
                                                <th class="text-start">@lang('Amount')({{ json_decode($generalSettings->business, true)['currency'] }})</th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
                                        <tfoot>
...
@push('scripts')
    ...
    <script>
        var table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('expenses.category.wise.expense') }}",
                "data": function(d) {
            ...
            columns: [
                ...
                {data: 'invoice_id', name: 'expenses.invoice_id'},
