            ...
            <form id="edit_purchase_return_form" action="{{ route('purchases.returns.supplier.return.update', $return->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row">
                            <div class="form_element">
                                <div class="py-2 px-2 form-header">
                                    <div class="row">
                                        <div class="col-6">
                                            <h6>@lang('Edit Purchase Return')</h6>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group mt-1">
                                                <label class="col-4"><b>@lang('Location') :</b> </label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group mt-1">
                                                <label class="col-4"><b>@lang('Warehouse') :</b>
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label class="col-4"><b>@lang('Return Date') :</b>
                                                    <span class="text-danger">*</span>
                                                </label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class="col-4"><b>@lang('Attachment') :</b> </label>
                                                <div class="col-8">
                            ...
                            <div class="form_element">
                                <div class="element-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="input-group mt-1">
                                                <label class="col-4"><strong>@lang('Tax') : </strong></label>
                                                <div class="col-8">

                                                    <select name="purchase_tax" class="form-control" id="purchase_tax">
                                                        <option value="0">@lang('NoTax')</option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label><strong> @lang('Tax Amount (+)') : </strong></label> <span class="label_purchase_tax_amount"> 0.00</span>
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <label class="col-4 text-center"><strong>@lang('Net Total Amount') : </strong> {{ json_decode($generalSettings->business, true)['currency'] }}</label>
                                                <div class="col-8">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <button id="save" class="btn btn-sm btn-primary float-end">@lang('Save')</button>
                    </div>
                </div>
