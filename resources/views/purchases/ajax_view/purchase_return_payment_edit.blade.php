...
<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">@lang('Edit Purchase Return Payment') <span class="type_name"></span></h6>
            ...
            <div class="info_area mb-2">
                <div class="row">
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong>@lang('Supplier') : </strong><span>{{ $payment->purchase->supplier->name }}</span></li>
                    ...
                    <div class="col-md-4">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong> @lang('Reference ID') : </strong><span class="invoice_no">{{ $payment->purchase->invoice_id }}</span>
                                </li>
