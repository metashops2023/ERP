                        ...
                        <div class="row">
                            <div class="form_element">
                                <div class="py-2 px-2 form-header">
                                    <div class="row">
                                        <div class="col-6">
                                            <h5>@lang('Add Stock Adjustment') <small> (@lang('Warehouse')) </small></h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group mt-1">
                                                <label class="col-4"><b>@lang('Adjust'). A<C :
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <label class=" col-4"><b>@lang('Voucher No') :</b>
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="invoice_id" id="invoice_id"
                                                        class="form-control" placeholder="@lang('Voucher No')">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label class=" col-4"><b>@lang('Adjust Date') :</b>
                                                    <span class="text-danger">*</span>
                                                </label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label class=" col-4"> <b>@lang('Type') :</b> <span class="text-danger">*</span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group mt-1">
                                                        <label class=" col-4"><b>@lang('Reason') :</b></label>
                                                        <div class="col-8">
