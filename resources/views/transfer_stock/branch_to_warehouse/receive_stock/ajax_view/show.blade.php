                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-left">
                        <ul class="list-unstyled">
                            ...
                            <li><strong>@lang('Name') :</strong> {{ $sendStock->branch ? $sendStock->branch->name.'/'.$transfer->branch->branch_code : json_decode($generalSettings->business, true)['shop_name'].'(HO)' }}</li>
        ...
        <div class="details_area">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="heading text-center">
                            ...
                            <small class="company_address">@lang('Phone') : {{ json_decode($generalSettings->business, true)['phone'] }}</small>
                            <h6 class="bill_name">@lang('Send Stock Invoice')</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="sale_and_deal_info pt-3">
                <div class="row">
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            <li><strong>@lang('Warehouse (Form)') : </strong></li>
                            <li><strong>@lang('Name') :</strong> {{ $sendStock->warehouse->warehouse_name.'/'.$sendStock->warehouse->warehouse_code }}</li>
                            <li><strong>@lang('Phone') : </strong> {{ $sendStock->warehouse->phone }}</li>
                            <li><strong>@lang('Address') : </strong> {{ $sendStock->warehouse->address }}</li>
                        </ul>
                    ...
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            ...
                            @else
                            <li>
                                <strong>@lang('Address') : </strong> {{ json_decode($generalSettings->business, true)['address'] }}
                            </li>
                            @endif
                        </ul>
                    </div>
