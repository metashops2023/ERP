                        ...
                        <div class="row">
                            <div class="form_element">
                                <div class="py-2 px-2 form-header">
                                    <div class="row">
                                        <div class="col-6">
                                            <h6>@lang('Edit Transfer Stock (Business Location To Warehouse)')</h6>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class="col-3"><b>@lang('B.Location') :</b><span class="text-danger">*</span></label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class=" col-2"><b>@lang('Date') :</b></label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class=" col-3"><b>@lang('Ref ID') :</b> </label>
                                                <div class="col-8">
                                                    <input type="text" name="invoice_id" id="invoice_id" class="form-control" placeholder="@lang('Reference ID')">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
