                        ...
                        <div class="row">
                            <div class="form_element">
                                <div class="py-2 px-2 form-header">
                                    <div class="row">
                                        <div class="col-6">
                                            <h6>@lang('Add Transfer Stock (Business Location To Warehouse)')</h6>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class="col-3"><b>@lang('B.Location') :</b></label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class=" col-3"><b>@lang('Ref ID') :</b>
