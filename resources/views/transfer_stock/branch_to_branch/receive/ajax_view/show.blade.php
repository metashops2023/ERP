    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            <li><strong>@lang('Send From') : </strong></li>
                    ...
                    <div class="col-lg-4">
                        <ul class="list-unstyled">
                            <li><strong>@lang('Receive From') : </strong></li>
                            <li><strong>@lang('B.Location') Name :</strong>
            ...
            <div class="modal-footer">
                <button type="button" class="footer_btn btn btn-sm btn-primary print_btn">@lang('Print')</button>
