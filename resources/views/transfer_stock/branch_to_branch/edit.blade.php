                        ...
                        <div class="row">
                            <div class="form_element">
                                <div class="py-2 px-2 form-header">
                                    <div class="row">
                                        <div class="col-6">
                                            <h5>@lang('Edit Transfer Stock (Business Location To Business Location)')</h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="ref_id" id="ref_id" class="form-control" placeholder="@lang('Reference ID')" value="{{ $transfer->ref_id }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                ...
                                                                @foreach ($transfer->transfer_products as $transfer_product)
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-start" colspan="2">
                                                                            ...
                                                                            <small class="text-muted">@lang('Current Stock') -{{ $qty_limits[$index].'<'.$transfer_product->product->unit->name }}<small>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group mt-1">
                                                        ...
                                                        <div class="col-8">
                                                            <input type="text" name="payment_note" class="form-control" id="payment_note" placeholder="@lang('Payment note')" autocomplete="off" value="{{ $transfer->payment_note }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="submit_button_area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-end">
                            ...
                            <button type="submit" class="btn btn-sm btn-success submit_button">@lang('Save Changes')</button>
                        </div>
                    </div>
                </div>
            </form>
