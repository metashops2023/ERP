                    ...
                    <div class="main__content">
                        ...
                        <div class="sec-name">
                            <div class="name-head">
                                ...
                                <h5>@lang('Transfer Stocks (Business Location To Business Location)')</h5>
                            </div>
                        </div>
                    ...
                    <div class="row margin_row mt-1">
                        <div class="card">
                            <div class="section-header">
                                <div class="col-md-10">
                                    <h6>@lang('Transfer List')</h6>
                                </div>

                                <div class="col-md-2">
                                    <div class="btn_30_blue float-end">
                                        <a href="{{ route('transfer.stock.branch.to.branch.create') }}" id="add_btn"><i class="fas fa-plus-square"></i> @lang('Add')</a>
                                    </div>
                                </div>
                                    ...
                                    <table class="display data_tbl table-sm table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>@lang('Sender Business Location')</th>
                                                <th>@lang('Receiver')</th>
                                                ...
                                                <th>@lang('Total Transfer Cost')({{ json_decode($generalSettings->business, true)['currency'] }})</th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
                                        <tfoot>
