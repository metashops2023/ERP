                        ...
                        <div class="row">
                            <div class="form_element">
                                <div class="py-2 px-2 form-header">
                                    <div class="row">
                                        <div class="col-6">
                                            <h6>@lang('Edit Transfer Stock')</h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="element-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label class=" col-3"><b>@lang('Ref'). ID :</b> </label>
                                                <div class="col-8">
                            ...
                            <div class="form_element">
                                <div class="element-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class=" col-4">@lang('Total Item'):</label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class=" col-4">@lang('Net Total') : {{ json_decode($generalSettings->business, true)['currency'] }}</label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class=" col-4">@lang('Ship Cost'):</label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <label for="inputEmail3" class="col-2">@lang('Note'):</label>
                                                <div class="col-10">
                ...
                <div class="submit_button_area py-3">
                    <div class="row">
                        <div class="col-md-12 text-end">
                            ...
                            <button type="submit" class="btn btn-sm btn-success submit_button">@lang('Update') </button>
                        </div>
                    </div>
                </div>
            </form>
