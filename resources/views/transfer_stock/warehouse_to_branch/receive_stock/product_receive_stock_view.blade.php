                        ...
                        <div class="row">
                            <div class="form_element">
                                ...
                                <div class="element-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="m-0"><strong>@lang('Reference ID'): </strong> <span class="transfer_invoice_id">SI-14252-45525588</span> </p>
                                            <p class="m-0"><strong>@lang('Date'): </strong> <span class="transfer_date">05-12-2020</span></p>
                                         </div>
                                         <div class="col-md-6">
                                            <p class="m-0"><strong>@lang('Business Location (From)'): </strong> <span class="branch">@lang('Dhaka Branch') - 145225</span></p>
                                             <p class="m-0"><strong>@lang('Warehouse (To)') : </strong> <span class="warehouse">@lang('Warehouse-1 (W-1)')</span> </p>
                                         </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <label for="inputEmail3" class="col-4">@lang('Receiver Note') :</label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <label for="inputEmail3" class=" col-4">@lang('Net Total') :</label>
                                                <div class="col-8">
