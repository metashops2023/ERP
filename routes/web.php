...
Route::middleware([
    ...
    Route::group(['prefix' => 'product', 'namespace' => 'App\Http\Controllers'], function () {
        ...
        Route::group(['prefix' => 'categories'], function () {
            ...
            Route::get('change/status/{categoryId}', 'CategoryController@changeStatus')->name('product.categories.change.status');
        });
        ...
        Route::group(['prefix' => 'sub-categories'], function () {
            ...
            Route::get('change/status/{categoryId}', 'SubCategoryController@changeStatus')->name('product.subcategories.change.status');
        });
        ...
        Route::group(['prefix' => 'brands'], function () {
            ...
            Route::get('change/status/{brandId}', 'BrandController@changeStatus')->name('product.brands.change.status');
        });
        ...
        Route::group(['prefix' => 'variants'], function () {
            ...
            Route::get('edit/{id}', 'BulkVariantController@edit')->name('product.variants.edit');
            Route::get('change/status/{id}', 'BulkVariantController@changeStatus')->name('product.variants.change.status');
        });
        ...
        Route::group(['prefix' => 'warranties'], function () {
            ...
            Route::get('edit/{id}', 'WarrantyController@edit')->name('product.warranties.edit');
            Route::get('change/status/{id}', 'WarrantyController@changeStatus')->name('product.warranties.change.status');
    ...
    Route::group(['prefix' => 'contacts', 'namespace' => 'App\Http\Controllers'], function () {
        ...
        Route::group(['prefix' => 'customers'], function () {
            ...
            Route::group(['prefix' => 'groups'], function () {
                ...
                Route::get('edit/{id}', 'CustomerGroupController@edit')->name('customers.group.edit');
                Route::get('change/status/{id}', 'CustomerGroupController@changeStatus')->name('customers.group.change.status');
            });
    ...
    Route::group(['prefix' => 'purchases', 'namespace' => 'App\Http\Controllers'], function () {
        ...
        Route::get('change/status/{id}', 'PurchaseController@change_status')->name('purchase.change.status');
        ...
        Route::group(['prefix' => 'returns'], function () {
            ...
            Route::get('show/payment/{returnId}', 'PurchaseReturnController@showPayment')->name('purchases.returns.show.payment');
            ...
            Route::get('change/status/{id}', 'PurchaseReturnController@changeStatus')->name('purchases.returns.change.status');
        });
    ...
    Route::group(['prefix' => 'settings', 'namespace' => 'App\Http\Controllers'], function () {
        ...
        Route::group(['prefix' => 'branches'], function () {
            ...
            // Route::get('edit/{id}', 'BranchController@edit')->name('settings.branches.edit');
            Route::get('change/status/{id}', 'BranchController@changeStatus')->name('settings.branches.change.status');
        });
        ...
        Route::group(['prefix' => 'units'], function () {
            ...
            Route::get('edit/{id}', 'UnitController@edit')->name('settings.units.edit');
            Route::get('change/status/{unitId}', 'UnitController@changeStatus')->name('settings.units.change.status');
        });
        ...
        Route::group(['prefix' => 'taxes'], function () {
            ...
            Route::get('edit/{id}', 'TaxController@edit')->name('settings.taxes.edit');
            Route::get('change/status/{taxId}', 'TaxController@changeStatus')->name('settings.taxes.change.status');
        });
        ...
        Route::group(['prefix' => 'payment_methods'], function () {
            ...
            // Route::get('edit/{id}', 'PaymentMethodController@edit')->name('settings.branches.edit');
            Route::get('change/status/{id}', 'PaymentMethodController@changeStatus')->name('settings.payment.method.change.status');
        });
        ...
        Route::group(['prefix' => 'invoices'], function () {
            ...
            Route::group(['prefix' => 'schemas'], function () {
                ...
                Route::get('change/status/{schemaId}', 'InvoiceSchemaController@changeStatus')->name('invoices.schemas.change.status');
            });
            ...
            Route::group(['prefix' => 'layouts'], function () {
                ...
                Route::get('change/status/{schemaId}', 'InvoiceLayoutController@changeStatus')->name('invoices.layouts.change.status');
            });
        });
        ...
        Route::group(['prefix' => 'cash_counter'], function () {
            ...
            Route::get('change/status/{id}', 'CashCounterController@changeStatus')->name('settings.cash.counter.change.status');
        });
