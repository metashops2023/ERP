...
class CreateTransferStockToWarehousesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transfer_stock_to_warehouses', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('branch_id')->nullable()->comment("form_branch");
            ...
            $table->foreign('branch_id', 'transfer_stock_to_warehouses_branch_id_foreign')->references('id')->on('branches')->onDelete('cascade');
            $table->foreign('warehouse_id', 'transfer_stock_to_warehouses_warehouse_id_foreign')->references('id')->on('warehouses')->onDelete('cascade');
        });
    }
