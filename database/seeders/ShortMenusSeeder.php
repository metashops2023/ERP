...
class ShortMenusSeeder extends Seeder
{
    ...
    public function run()
    {
        $short_menus = array(
            ...
            array('id' => '26','url' => 'expenses.create','name' => 'Add Expense','icon' => 'fas fa-plus-square','created_at' => NULL,'updated_at' => NULL),
            array('id' => '27','url' => 'expenses.index','name' => 'Expense List','icon' => 'far fa-list-alt','created_at' => NULL,'updated_at' => NULL),
            array('id' => '28','url' => 'expenses.categories.index','name' => 'Ex. Categories','icon' => 'fas fa-cubes','created_at' => NULL,'updated_at' => NULL),
